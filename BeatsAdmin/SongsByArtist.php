...
$result = $admin -> select("select UserName from users where ID='".$_REQUEST["ID"]."'");
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4 text-warning">Artist Name : <?php echo $ArtistName; ?></h2>
                            <div class="table-responsive">
                                <table class="table" style="color:white">
                                    ...
                                    <tbody id="myTbl">
                                        ...
                                        $result = $admin->select("select * from songsinfo where ID='".$_REQUEST["ID"]."'");
